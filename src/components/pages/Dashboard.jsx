            ...
            <div className="space-y-4">
              {recentWins.map((win) => (
                <div key={win.Id} className="flex items-start space-x-3">
                  <div className="w-8 h-8 bg-gradient-to-br from-warning to-yellow-500 rounded-full flex items-center justify-center">
                  ...
                  <tr key={metric.Id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 text-right">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        metric.optimizationScore >= 90 
                          ? 'bg-secondary/10 text-secondary' 
                          : metric.optimizationScore >= 80 
